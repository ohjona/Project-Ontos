...
## 2. Current State (v2.9.0 in progress)

> **Update 2025-12-22:** PR #31 (Schema Versioning) is now MERGED.
> Version is now 2.9.0 with 327 tests passing.
...
| **Schema versioning** | ✅ **NEW (PR #31)** | `.ontos/scripts/ontos/core/schema.py` |
| **Migration CLI** | ✅ **NEW (PR #31)** | `.ontos/scripts/ontos_migrate_schema.py` |
| 327 tests passing | ✅ Complete | `.ontos/scripts/tests/` |
...
.ontos/scripts/ontos/core/schema.py         # Schema versioning (NEW - PR #31)
...
.ontos/scripts/ontos_promote.py           # Promote L0/L1 → L2
...
- `promote` command with interactive UX and goal→summary seeding
