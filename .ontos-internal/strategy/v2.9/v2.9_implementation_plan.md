...
| #34 | Deprecation Warnings | v2.9.2 | 🔄 NEXT | — | Section 5 |
| #35 | install.py Bootstrap | v2.9.3 | 🔲 PENDING | — | Section 2 |
...
### PR #34 Prerequisites (v2.9.2)

Before starting PR #34 (Deprecation Warnings), ensure:

1. ✅ PR #31 merged (Schema Versioning)
2. ✅ PR #33 merged (Curation Levels)
3. 🔲 Add `FutureWarning` to `ontos_lib.py` on import
4. 🔲 Add `ONTOS_CLI_DISPATCH` env var to `ontos.py`
5. 🔲 Add deprecation notices to direct script execution
6. 🔲 Configure pytest warning filters
