...
12. [Implementation Progress](#12-implementation-progress) *(NEW)*
...
| PR | Feature | Status | Merged | Notes |
|----|---------|--------|--------|-------|
| **#31** | Schema Versioning | ✅ MERGED | 2025-12-22 | See [3.5.1](#351-actual-api-pr-31) for API differences |
| #32 | Curation Levels | 🔄 PENDING | — | Depends on VALID_STATUS update |
| #33 | Deprecation Warnings | 🔄 PENDING | — | |
| #34 | install.py Bootstrap | 🔄 PENDING | — | |
| #35 | Integration Tests | 🔄 PENDING | — | |

### Files Added/Modified in PR #31
...
Before starting PR #32 (Curation Levels), ensure:

1. ✅ PR #31 merged
2. 🔲 Update `VALID_STATUS` to include `scaffold`, `pending_curation`
3. 🔲 Create `ontos/core/curation.py`
4. 🔲 Use actual schema.py API (not plan's theoretical code)

**Import pattern for PR #32:**
```python
from ontos.core.schema import (
